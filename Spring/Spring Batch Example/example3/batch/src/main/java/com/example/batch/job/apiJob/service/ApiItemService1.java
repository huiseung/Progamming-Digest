...
@Service
public class ApiItemService1 extends AbstractApiService{

    @Override
    protected ApiResponseDto doApiService(RestTemplate restTemplate, ApiInfo apiInfo) {
        ResponseEntity<String> response = restTemplate.postForEntity("http://localhost:8000/api/product/1", apiInfo, String.class);
